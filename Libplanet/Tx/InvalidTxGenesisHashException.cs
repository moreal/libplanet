...
{
    /// <summary>
    /// The exception that is thrown when the <see cref="UnsignedTransaction{T}.GenesisHash"/>
    ...
    public sealed class InvalidTxGenesisHashException : InvalidTxException
    {
        ...
        /// <see cref="UnsignedTransaction{T}.GenesisHash"/>.  This can be <c>null</c>.</param>
        ...
        /// <summary>
        /// The actual <see cref="UnsignedTransaction{T}.GenesisHash"/>, which is improper.
        /// </summary>
